...
const messages: Messages = {
  ...
  home: {
    ...
    padTip: 'Las páginas de iPad admiten 2752 × 2064 en horizontal; en el espacio de trabajo puedes alternar vertical/horizontal en cada tarjeta',
    start: 'Comenzar',
